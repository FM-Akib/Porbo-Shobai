...
const OpportunityCard = ({ opportunity }) => {
  ...
  return (
    <Card className="w-full max-w-sm overflow-hidden group hover:shadow-xl transition-all duration-300 dark:bg-gray-800">
      <div className={cn("h-fit py-1 text-center text-white font-semibold w-full", bannerAnimation)}>
      ...
      <div className="relative overflow-hidden">
        ...
        font-semibold px-2 py-1 rounded-sm flex z-10`}>
          <Dot className="animate-ping" />{opportunity.status}
        </div>
      </div>
      ...
      <CardContent className="pt-6 space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-1">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">{daysDifference} days left</span>
          </div>
        </div>

        <div className="flex items-center justify-between">
          <span className="text-xl font-bold text-orange-600 dark:text-orange-400">
            <span className="text-xl font-extrabold">৳</span> {prize}
          </span>
