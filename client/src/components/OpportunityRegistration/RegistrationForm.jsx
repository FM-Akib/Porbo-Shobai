...
export function RegistrationForm({ Aopportunity }) {
  ...
  function handleAddMember(memberData) {
    if (teamMembers.length +1 >= Aopportunity?.teamSize?.maxSize) {
      toast.error(`You can only add ${ Aopportunity?.teamSize?.maxSize} team members!`);
      return;
    }
    ...
    <>
      <Form {...form}>
...

         {
            Aopportunity?.registrationFee > 0 && (
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2">
                      <CreditCard className="w-4 h-4" /> Transaction ID (BDT {Aopportunity?.registrationFee})
                    </FormLabel>
                    <FormControl>
      ...
      
        {
          ...
          {teamMembers.length +1 <  Aopportunity?.teamSize?.maxSize && Aopportunity?.participationType === "team" && (
            <Button
              type="button"
              variant="outline"
            ...
            >
              ...
              Add Other Team Member ({teamMembers.length +1}/{ Aopportunity?.teamSize?.maxSize})
            </Button>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Button
            className="w-full bg-gradient-to-r  text-white py-6 flex items-center justify-center"
          >
