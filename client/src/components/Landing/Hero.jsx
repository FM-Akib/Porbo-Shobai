    ...
    <div className="container mx-auto p-4 md:p-8 max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 md:my-20">
      ...
      <div className="mb-8 md:mb-12 h-full flex flex-col justify-center ">
        ...
        <div className="flex items-center gap-2 mb-4 ">
          <WordRotate
            ...
            words={[
              'Unlock Opportunities, Rewards, and Redeem Knowledge.',
              'Where Learning Meets Opportunity and Rewards.',
              'Compete, Learn, and Redeem Your Education.',
              'Opportunities, Mentorship, and Education at Your Fingertips!',
            ]}
          />
        ...
        <p className=" text-lg max-w-2xl pe-10 text-left">
          Porbo Shoabi connects students with{' '}
          <span className="bg-yellow-200 dark:bg-gray-800 px-1 py-1 rounded">
            {' '}
            opportunities, competitions, and mentors.
          </span>{' '}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  gap-4 md:gap-5 ">
        ...
        <Card className="bg-[url(https://res.cloudinary.com/ds0io6msx/image/upload/v1733209916/jtbuvkly72ihzk3kskad.gif)] bg-cover border-none hover:shadow-lg transition-shadow">
          ...
          <CardContent className="text-gray-700">
            <p className="font-medium">
              Exchange your points <br /> for rewards
            </p>
            <Badge variant="secondary" className="mt-2">
              200+ Rewards
            </Badge>
