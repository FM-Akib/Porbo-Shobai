            ...
            <CardDescription className="bg-gradient-to-r from-[rgb(131,58,180)] via-[rgb(253,29,29)] to-[rgb(252,176,69)] dark:bg-transparent rounded">
              ...
              >
                <h1 className="text-4xl font-bold text-white">
                  Host <br className="block md:hidden" /> An Opportunity
                </h1>
              </div>
            </CardDescription>
          </CardHeader>
            ...
            <Form {...form}>
              ...
              >
                            ...
                            <div className="flex flex-1 items-center gap-2">
                              ...
                              <div className="">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Participant participates individually.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          >
                            ...
                            <div className="flex flex-1 items-center gap-2">
                              ...
                              <div className="">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Participant participates in a team.
                                </p>
                              </div>
                            </div>
                          </div>
                ...
                <Button
                  type="button"
                  onClick={() =>
                    appendContact({ name: '', email: '', mobile: '' })
                  }
                  className="mt-4"
                >
                  <PlusCircle className="w-4 h-4 mr-1" />
                ...
                <div>
                  ...
                  {prizeFields.map((field, index) => (
                    <div
                      key={field.id}
                      className="space-y-4 mb-4 border px-4 py-2 rounded-lg"
                    >
                  ...
                  <Button
                    type="button"
                    onClick={() =>
                      appendPrize({ prizeName: '', prizeAmount: 0 })
                    }
                  >
                    <PlusCircle className="w-4 h-4 mr-1" />
                    Add Prize
                ...
                <div className="flex justify-end gap-4">
                  ...
                  {isLoading ? (
                    ...
                    <Button type="submit" className="flex items-center">
                      Submit <SendHorizontal className="w-4 h-4 " />
                    </Button>
                  )}
                </div>
              </form>
