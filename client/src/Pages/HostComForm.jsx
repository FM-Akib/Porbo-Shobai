           ...
           <Link to="/host-competitions">
            ...
            <div className="flex flex-col md:flex-row items-center gap-2">
              <div className="flex h-8 items-center gap-2 rounded-full bg-primary px-4 text-sm text-primary-foreground">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-white text-xs text-primary">
                  1
                </span>
                Basic Details
              </div>
                        ...
                        <FormControl>
                          ...
                          >
                            <div className={cn(
                              ...
                              <label htmlFor="online" className="font-medium">Online Mode</label>
                            </div>
                            <div className={cn(
                              "flex flex-1 cursor-pointer items-center gap-2 rounded-lg border p-4 transition-colors",
